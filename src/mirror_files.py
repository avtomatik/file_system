...
from core.helpers import (copy_files_to_destination,
                          extract_file_names_from_text_file,
                          get_file_names_as_set, get_filtered_file_names)
...
def mirror_files(path_from, path_to, FILE_NAME_L, FILE_NAME_R):
    ...
    copy_files_to_destination(tuple(file_names_l - file_names_r), path_from, path_to)

    copy_files_to_destination(tuple(file_names_r - file_names_l), path_to, path_from)
...
def mirror_files(path_from, path_to):
    ...
    # TODO: Review the Logic
    # =========================================================================
    file_names_l = get_file_names_as_set(path_from)
    file_names_r = get_file_names_as_set(path_to)
